...
func (g Generator) Create() (string, error) {
	...
	for _, kubeObj := range g.YamlFiles {
		...
		if objMeta.Kind == "Pod" {
			...
			fmt.Printf("%v is not supported. Please add manually. Consider filing bug here: https://github.com/jpdasma/chartify-ng/issues", objMeta.Kind)
		}
...
func chartMetaData(name string) chart.Metadata {
	return chart.Metadata{
		Name:        name,
		Description: "Helm chart generated by https://github.com/jpdasma/chartify-ng",
		Version:     "0.1.0",
		ApiVersion:  "v1",
	}
}
